...
<input type="checkbox" id="include-mosaic-tiles" onchange="refreshExamples()" /> Include nbs mosaic
</label>
</div>
</div>
...
function refreshExamples() {
    ...
    var cli = '<span class="fn">nbs fetch</span> <span class="param">-d</span> <span class="str">"' + ed + '"</span> <span class="param">-g</span> <span class="str">\'' + eg + '\'</span>';
    if (includeBuild) cli += '\n<span class="fn">nbs mosaic</span> <span class="param">-d</span> <span class="str">"' + ed + '"</span>';
